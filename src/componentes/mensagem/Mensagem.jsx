...
function Mensagem() {
  return (
    <div className={style.pageContainer}>
        ...
        <div className={style.userSidebar}>
          ...
          <div className={style.onlineFriends}>
            ...
            <div className={style.friend}>
              <img src="https://via.placeholder.com/40" alt="Severino" className={style.profileImage} />
              <div>
                <span>Mr_Seven</span>
            ...
            <div className={style.friend}>
              <img src="https://via.placeholder.com/40" alt="Gustavo" className={style.profileImage} />
              <div>
            ...
            <div className={style.friend}>
              <img src="https://via.placeholder.com/40" alt="Elisama" className={style.profileImage} />
              <div>
                <span>Elisama</span>
                <small className={style.timestamp}>Hoje, 10:30 AM</small>
              </div>
            ...
            <div className={style.friend}>
              <img src="https://via.placeholder.com/40" alt="Jeremias" className={style.profileImage} />
              <div>
                <span>Jeremias</span>
                <small className={style.timestamp}>Hoje, 10:30 AM</small>
              </div>
          ...
          <div className={style.groupChats}>
            ...
            <div className={style.group}>
              <img src="https://via.placeholder.com/40" alt="Grupo 1" className={style.profileImage} />
              <div>
            ...
            <div className={style.group}>
              <img src="https://via.placeholder.com/40" alt="Grupo 2" className={style.profileImage} />
              <div>
      ...
      <div className={style.smallChatBox}>
        <div className={style.chatHeader}>
          <span>Mini Chat</span>
          <MdOutlineManageSearch className={style.searchIcon} />
        </div>
